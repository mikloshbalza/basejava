            ...
            <c:forEach var="type" items="<%=SectionType.values()%>">
                ...
                <c:choose>
                    ...
                    <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                        <c:forEach var="org" items="<%=((CompanySection) section).getCompanies()%>" varStatus="counter">
                            <c:choose>
                            ...
                            <input class="field" type="text" placeholder="Ссылка" name='${type}url' size=100 value="${org.url}">
